...
<body>
                ...
                <?php if (!empty($consultations)): ?>
                    <?php foreach ($consultations as $record): ?>
                        <div class="consultation-card">
                            ...
                            <p><b>Duration (Days):</b> <?= htmlspecialchars($record['DurationDays'] ?? 'No information found') ?></p>
                            ...
                            <p><b>Fecal Score:</b> <?= htmlspecialchars($record['FecalScore'] ?? 'No information found') ?></p>
    ...
    // ✅ Fetch and update consultation records
                ...
                data.forEach(record => {
                    let recordElement = `
                        <div class="consultation-card">
                            ...
                            <p><b>Chief Complaint:</b> ${record.ChiefComplaint || 'N/A'}</p>
                            ...
                            <p><b>Medication Prior Checkup:</b> ${record.MedicationPriorCheckup || 'N/A'}</p>
