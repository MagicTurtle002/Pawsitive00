...
<body>
                    ...
                    <form class="staff-form" action="add_pet.php" method="POST">
                        ...
                        <div class="form-row">
                            <div class="input-container">
                                ...
                                <input type="text" id="Name" name="Name" required minlength="3" aria-invalid="false"
                        ...
                        <div class="form-row">
                            <div class="input-container">
                                <label for="ProfilePicture">Upload Profile Picture:<span
    ...
    <script src="../../assets/js/add_pet.js"></script>
