...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($formData['weight']) || floatval($formData['weight']) <= 0)
    ...
    if ($pet_check->rowCount() === 0)
        $errors['pet_id'] = "Invalid Pet ID.";
    ...
    if (empty($errors)) {
        try {
            ...
            $_SESSION['errors']['database'] = "Database error: " . $e->getMessage(); // Show full error message
        }
    } else {
...
<body>
            ...
            <div class="form-group">
                <div class="form-row">
                    <div class="input-container">
                        ...
                        <input type="text" value="<?= htmlspecialchars($pet['Name'] ?? 'Unknown Pet', ENT_QUOTES); ?>"
                            readonly>
                ...
                <div class="form-row">
                    <div class="input-container">
                        ...
                        <input type="text" id="vaccine_name" name="vaccine_name"
                            value="<?= htmlspecialchars($formData['vaccine_name'] ?? '', ENT_QUOTES); ?>" required>
                    ...
                    <div class="input-container">
                        ...
                        <input type="date" id="vaccination_date" name="vaccination_date"
                            value="<?= htmlspecialchars($formData['vaccination_date'] ?? date('Y-m-d'), ENT_QUOTES); ?>"
                            required>
                ...
                <div class="form-row">
                    <div class="input-container">
                        ...
                        <input type="text" id="manufacturer" name="manufacturer"
                            value="<?= htmlspecialchars($formData['manufacturer'] ?? '', ENT_QUOTES); ?>" required>
                    ...
                    <div class="input-container">
                        ...
                        <input type="text" id="lot_number" name="lot_number"
                            value="<?= htmlspecialchars($formData['lot_number'] ?? '', ENT_QUOTES); ?>" required
    ...
    <script>
        ...
        document.querySelector(".confirm-btn").addEventListener("click", confirmSubmission);
